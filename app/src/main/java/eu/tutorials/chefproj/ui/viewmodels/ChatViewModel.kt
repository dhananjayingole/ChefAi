                ...
                result.fold(
                    onSuccess = { response ->
                        ...
                        val aiMessage = ChatMessage(
                            ...
                            nutrition = if (isRecipeIntent) response.nutrition else null,
                            budget    = if (isRecipeIntent) response.budget else null,
                            eco       = if (isRecipeIntent) response.eco else null,
